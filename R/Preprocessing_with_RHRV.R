...
#' according to blood pressure levels that can be defined by the user, as well as heart rate levels.
#' The latter heart rate threshold levels and the overall methodology are based on the work of 
