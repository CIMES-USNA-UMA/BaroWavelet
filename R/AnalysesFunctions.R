...
AddAnalysis <- function(framework, name = NULL) {
  ...
  output$Name <- name
  framework$Raw[[N + 1]] <- output
  framework$Raw[[N + 1]]$Data <- list()
...
#' @param framework An analysis environment generated by \link[BaroWavelet]{BuildStructure}
#' @param locator A locator index indicating which analysis slot needs to be used
...
#' @param framework An analysis environment generated by \link[BaroWavelet]{BuildStructure}
#' @param locator_a A locator index indicating which analysis slot needs to be used
#' @param locator_t A locator index indicating which time interval is to be used
#' @param time_flags A vector containing the minimum and maximum limits of a time interval, in minutes.
#'                   Default is NULL.
...
#' @param use.raw Boolean. If TRUE, HR and BP estimates will be computed from non-interpolated time series
#'
...
#'
#' Plots BRS HF and LF indices associated to a specific subject
#' @param framework An analysis environment generated by \link[BaroWavelet]{BuildStructure}
#' @param locator A locator index indicating which analysis slot needs to be used
...
#'
#' Compares two groups of paired or unpaired data to check for significant differences
#' @param framework An analysis environment generated by \link[BaroWavelet]{BuildStructure}
#' @param locator1 A locator index indicating which interval slot needs to be used
#' @param locator2 A locator index indicating another interval slot to perform the comparison
...
#' @param framework An analysis environment generated by \link[BaroWavelet]{BuildStructure}
#' @param locator A locator index indicating which test should be used
#' @param tem Boolean, creates a temporal file for the plot. Default is FALSE
#' @param newPlot Boolean, generates a new plot without overwriting a previous plot. Default is TRUE
...
#' @param framework An analysis environment generated by \link[BaroWavelet]{BuildStructure}
#' @param locator A locator index indicating which analysis should be used
#'
#' @return A list containing relevant data from a specific analysis
#'
#' @author Alvaro Chao-Ecija
#'
#'
...
AddTimeValues <-
  function(framework,
    ...
    interval <- framework$IndividualIndices[[locator_t]]
    if(use.raw){
      Analysis <- framework$Raw[[locator_a]]
    } else {
      Analysis <- framework$Analyses[[locator_a]]
    }
    HR <- interval$HR
